...
**Hook:** Similarity is not permission to transfer a lesson.

**Runnable proof:** Run `make test && make demo`; an incompatible issuer/domain case remains blocked even when it looks semantically similar.

**Evolved prompt:** [`PROMPT.md`](./PROMPT.md)  
**Source prompt:** https://github.com/EAZITECH1/exam-mistake-memory  
...
The evaluator is local policy evidence, not a financial score or decision. The receipt manifest is committed evidence, not a fresh live run.
